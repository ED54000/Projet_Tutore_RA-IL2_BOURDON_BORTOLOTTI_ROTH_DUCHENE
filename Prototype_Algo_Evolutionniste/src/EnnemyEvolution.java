...
public class EnnemyEvolution {
        ...
        for (Ennemy e : ennemies) {
            switch (e.getBehavior()){
                case "Fugitive":
                    ...
                    double score = distStartEnd - e.getDistanceToArrival() + 0.2 * e.getTempsSurvie();
                ...
                case "Normal":
                    // On calcule le score de l'ennemi
                    score = 1/e.getDistanceToArrival() + 0.2 * e.getTempsSurvie();
                    // On ajoute des points si l'ennemi est arrivé
                    if(e.isArrived()){
                        score += 10000;
                    }
     ...
     * @param ennemies la liste complète des ennemis
     */
    public static void affectStatsToDeadEnnemies(List<Ennemy> ennemies) {
     ...
     * @param ennemies la liste complète des ennemis
     */
    public static void addRandomStats(List<Ennemy> ennemies) {
        // Pour chaque ennemi
        for(Ennemy e: ennemies) {
